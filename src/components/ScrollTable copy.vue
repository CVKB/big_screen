...
import { nextTick, reactive, ref, useAttrs, watch } from "vue";
...
<template>
  <vxe-table @mouseover="handleMouseover" @mouseleave="handleMouseleave" @scroll="handleScroll"
    @vue:updated="tableUpdated" ref="tableRef" class="mytable-scrollbar" v-bind="getAttrs()" :data="tableData">
    <slot></slot>
  </vxe-table>
</template>
...
.vxe-table--body-wrapper {
  overflow: hidden !important; // 默认隐藏滚动条

  &:hover {
    overflow: auto !important; // 鼠标悬停时显示滚动条
  }
